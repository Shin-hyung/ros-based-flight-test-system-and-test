...
(cl:defmethod cl:initialize-instance :after ((m <TestMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TestMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tutorial-msg:<TestMsg> is deprecated: use tutorial-msg:TestMsg instead.")))
...
(cl:defmethod z-val ((m <TestMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tutorial-msg:z-val is deprecated.  Use tutorial-msg:z instead.")
  (z m))
