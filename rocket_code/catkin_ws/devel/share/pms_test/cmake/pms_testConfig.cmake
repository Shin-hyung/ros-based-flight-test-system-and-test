...
if(NOT "/home/rocket/catkin_ws/src/pms_test/include " STREQUAL " ")
  set(pms_test_INCLUDE_DIRS "")
  set(_include_dirs "/home/rocket/catkin_ws/src/pms_test/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pms_test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rocket/catkin_ws/src/pms_test/${idir}'.  ${_report}")
    endif()
